...
// EZoneHTZoneGraphDisturbanceLevel        DangerLevel                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UZoneGraphDisturbanceAnnotationBPLibrary::TriggerDanger(class UObject* WorldContextObject, const class AActor* Instigator, const struct FVector& position, const float Radius, const float duration, EZoneHTZoneGraphDisturbanceLevel DangerLevel)
{
	static class UFunction* Func = nullptr;
