...
struct BulletActor_LacrimosaPan_C_ExecuteUbergraph_BulletActor_LacrimosaPan final
{
public:
	...
	class UNiagaraComponent*                      CallFunc_SpawnEmitterAtLocation_ReturnValue;       // 0x01C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BulletActor_LacrimosaPan_C_ExecuteUbergraph_BulletActor_LacrimosaPan;

// Function BulletActor_LacrimosaPan.BulletActor_LacrimosaPan_C.ReceiveHit
// 0x0170 (0x0170 - 0x0000)
struct BulletActor_LacrimosaPan_C_ReceiveHit final
{
public:
...
DUMPER7_ASSERTS_BulletActor_LacrimosaPan_C_ReceiveHit;
