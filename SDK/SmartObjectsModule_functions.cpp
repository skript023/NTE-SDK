...
bool USmartObjectSubsystem::IsSlotEnabled(const struct FSmartObjectSlotHandle& SlotHandle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SmartObjectSubsystem", "IsSlotEnabled");

	Params::SmartObjectSubsystem_IsSlotEnabled Parms{};
