...
struct Con_Lacrimosa_TargetGotTreatment_C_CanApplyGameplayEffectContent final
{
public:
	...
	class UHTAbilitySystemComponent*              CallFunc_GetHTAbilitySystemComponent_ReturnValue_1; // 0x0030(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_K2_HaveGameplayEffectWithClass_ReturnValue; // 0x003B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Lacrimosa_TargetGotTreatment_C_CanApplyGameplayEffectContent;
