...
public:
	...
	TSet<class AActor*>                           ActiveNetworkActors;                               // 0x0190(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0548(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0550(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x0568(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	class UReplicationGraphNode*                  DynamicNode;                                       // 0x0100(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UReplicationGraphNode_DormancyNode*     DormancyNode;                                      // 0x0108(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x02C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x02D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
