...
struct BP_EnableAimingWhilePlayingMontageNS_C_Received_NotifyEnd final
{
public:
	...
	uint8                                         CallFunc_Subtract_ByteByte_ReturnValue;            // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_EnableAimingWhilePlayingMontageNS_C_Received_NotifyEnd;

// Function BP_EnableAimingWhilePlayingMontageNS.BP_EnableAimingWhilePlayingMontageNS_C.Received_NotifyBegin
// 0x0068 (0x0068 - 0x0000)
struct BP_EnableAimingWhilePlayingMontageNS_C_Received_NotifyBegin final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_EnableAimingWhilePlayingMontageNS_C_Received_NotifyBegin;
