...
struct BP_AnimNotify_ChangePoliceWeaponSocket_C_Received_Notify final
{
public:
	...
	class AHTCrowdAgentCharacter*                 K2Node_DynamicCast_AsHTCrowd_Agent_Character;      // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_AnimNotify_ChangePoliceWeaponSocket_C_Received_Notify;
