...
struct BP_TreasureBox_TrackGoal_C_Received_Notify final
{
public:
	...
	class AHTStaticTreasureBoxActor*              K2Node_DynamicCast_AsHTStatic_Treasure_Box_Actor;  // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_TreasureBox_TrackGoal_C_Received_Notify;
