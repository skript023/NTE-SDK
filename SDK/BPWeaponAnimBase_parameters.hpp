...
struct BPWeaponAnimBase_C_PhysicsAnimInterface final
{
public:
	struct FPoseLink                              InPose;                                            // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
	struct FPoseLink                              PhysicsAnimInterface_0;                            // 0x0010(0x0010)(Parm, OutParm, NoDestructor)
};
DUMPER7_ASSERTS_BPWeaponAnimBase_C_PhysicsAnimInterface;
...
public:
	...
	EOwnerCharacterState                          K2Node_Event_NewState;                             // 0x001A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EOwnerCharacterState                          K2Node_Event_OldState;                             // 0x001B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BPWeaponAnimBase_C_ExecuteUbergraph_BPWeaponAnimBase;
...
DUMPER7_ASSERTS_BPWeaponAnimBase_C_BPOwnerCharacterStateChange;
...
DUMPER7_ASSERTS_BPWeaponAnimBase_C_AnimGraph;
