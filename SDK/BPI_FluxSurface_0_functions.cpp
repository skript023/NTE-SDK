...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::SetSignedDistanceFieldMask(class UPDA_FluxSignedDistanceField_C* SignedDistanceField)
{
	static class UFunction* Func = nullptr;
...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::SetGeneratorMode(class UStaticMesh* GeneratorMesh, bool Visible)
{
	static class UFunction* Func = nullptr;
...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::SetColorPreset(int32 Index_0, class PDA_FluxSurfacePreset::UPDA_FluxSurfacePreset_C* Preset)
{
	static class UFunction* Func = nullptr;
...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::SetCoastlineState(class PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C* State)
{
	static class UFunction* Func = nullptr;
...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::GetColorPreset(int32 Index_0, class PDA_FluxSurfacePreset::UPDA_FluxSurfacePreset_C** Preset)
{
	static class UFunction* Func = nullptr;
...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::ApplySurfaceNiagaraData(class UNiagaraComponent* ParticleSystem, bool RequiredGround, bool RequiredWave, bool RequreSDF)
{
	static class UFunction* Func = nullptr;
...
void BPI_FluxSurface_0::IBPI_FluxSurface_C::ApplySurfaceMaterialData(const TArray<class UMaterialInstanceDynamic*>& Materials, bool Domains, bool Colors)
{
	static class UFunction* Func = nullptr;
