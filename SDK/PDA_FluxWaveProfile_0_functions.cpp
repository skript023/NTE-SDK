...
#include "PDA_FluxWaveProfile_0_classes.hpp"
#include "PDA_FluxWaveProfile_0_parameters.hpp"
...
void PDA_FluxWaveProfile_0::UPDA_FluxWaveProfile_C::SetWaveProfileData(class UTexture* WaveProfilesForward, class UTexture* WaveProfilesInverse, const struct FLinearColor& WaveProfileDecode_0, int32 Frames_0, int32 WaveWidth, int32 WaveHeight_0)
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxWaveProfile_0::UPDA_FluxWaveProfile_C::ApplyWaveProfileNiagaraData(class UNiagaraComponent* NiagaraSystem) const
{
	static class UFunction* Func = nullptr;
