...
// Function Cau_Fadia_Q_RecoverHP.Cau_Fadia_Q_RecoverHP_C.HTCustomCalculateBaseMagnitude
// 0x0090 (0x0090 - 0x0000)
struct Cau_Fadia_Q_RecoverHP_C_HTCustomCalculateBaseMagnitude final
{
public:
	...
	float                                         TempAdditiveMaxHPMulLv4;                           // 0x001C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         TempHPMax;                                         // 0x0020(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         TempMaxHPMul;                                      // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetHPMax_ReturnValue;                     // 0x0034(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EEvaluateCurveTableResult                     CallFunc_EvaluateCurveTableRow_OutResult;          // 0x0039(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_VariableSet_TempMaxHPMul_ImplicitCast;      // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Cau_Fadia_Q_RecoverHP_C_HTCustomCalculateBaseMagnitude;
