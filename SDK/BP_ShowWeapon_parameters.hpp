...
struct BP_ShowWeapon_C_Received_NotifyEnd final
{
public:
	...
	class AWeaponBase*                            CallFunc_GetCurrentWeapon_ReturnValue;             // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_ShowWeapon_C_Received_NotifyEnd;

// Function BP_ShowWeapon.BP_ShowWeapon_C.Received_NotifyBegin
// 0x0070 (0x0070 - 0x0000)
struct BP_ShowWeapon_C_Received_NotifyBegin final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AWeaponBase*                            CallFunc_GetCurrentWeapon_ReturnValue;             // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_ShowWeapon_C_Received_NotifyBegin;
