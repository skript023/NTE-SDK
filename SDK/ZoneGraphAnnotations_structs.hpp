...
// Enum ZoneGraphAnnotations.EZoneHTZoneGraphDisturbanceLevel
// NumValues: 0x0004
enum class EZoneHTZoneGraphDisturbanceLevel : uint8
{
	None                                     = 0,
	LowDanger                                = 1,
	HighDanger                               = 2,
	EZoneHTZoneGraphDisturbanceLevel_MAX     = 3,
};
...
public:
	...
	EZoneHTZoneGraphDisturbanceLevel              DangerLevel;                                       // 0x0024(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
