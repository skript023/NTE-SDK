...
struct Con_Skia_ExtraShadowDamage_C_CanApplyGameplayEffectContent final
{
public:
	...
	TArray<class UClass*>                         DamageGEArray;                                     // 0x0028(0x0010)(Edit, BlueprintVisible)
	...
	class UHTAbilitySystemComponent*              CallFunc_GetHTAbilitySystemComponent_ReturnValue;  // 0x0058(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_K2_HaveGameplayEffectWithClass_ReturnValue; // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Con_Skia_ExtraShadowDamage_C_CanApplyGameplayEffectContent;
