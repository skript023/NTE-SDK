...
struct Con_Hathor_AngerActive_AtkUp_Del_C_CanApplyGameplayEffectContent final
{
public:
	...
	class UHTGameplayAbility*                     CallFunc_GetCurSkillInstanceByMontage_ReturnValue; // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Con_Hathor_AngerActive_AtkUp_Del_C_CanApplyGameplayEffectContent;
