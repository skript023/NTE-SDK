...
struct Con_Skia_Level2_Check_C_CanApplyGameplayEffectContent final
{
public:
	...
	TArray<struct FGameplayTag>                   K2Node_MakeArray_Array;                            // 0x0048(0x0010)(ReferenceParm)
};
DUMPER7_ASSERTS_Con_Skia_Level2_Check_C_CanApplyGameplayEffectContent;
