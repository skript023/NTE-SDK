...
// Function Con_Equipment_Psyche_4.Con_Equipment_Psyche_4_C.CanApplyGameplayEffectContent
// 0x0058 (0x0058 - 0x0000)
struct Con_Equipment_Psyche_4_C_CanApplyGameplayEffectContent final
{
public:
	...
	EReactionResultType                           CallFunc_GetReactionResultType_ReturnValue;        // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x0052(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Equipment_Psyche_4_C_CanApplyGameplayEffectContent;
