...
#include "BP_FluxDataComponent_0_parameters.hpp"
...
void BP_FluxDataComponent_0::UBP_FluxDataComponent_C::ReceiveParticleData(const TArray<struct FBasicParticleData>& Data, class UNiagaraSystem* NiagaraSystem, const struct FVector& SimulationPositionOffset)
{
	static class UFunction* Func = nullptr;
...
void BP_FluxDataComponent_0::UBP_FluxDataComponent_C::GetOwnerComponent(class USceneComponent** SceneComponent) const
{
	static class UFunction* Func = nullptr;
