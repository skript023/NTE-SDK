...
struct Con_Kuhara_HaveSeed_C_CanApplyGameplayEffectContent final
{
public:
	...
	int32                                         CallFunc_K2_GetSourceGameplayEffectStackCountWithClass_ReturnValue; // 0x0034(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue;               // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Kuhara_HaveSeed_C_CanApplyGameplayEffectContent;
