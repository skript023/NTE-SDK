...
struct DamageActorLacrimosaUltraSkill_C_ExecuteUbergraph_DamageActorLacrimosaUltraSkill final
{
public:
	...
	class AHTSnowInteractionManager*              CallFunc_GetSnowManager_ReturnValue;               // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector4                               CallFunc_MakeVector4_ReturnValue_1;                // 0x0140(0x0020)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFieldInfluenceCapsule                 K2Node_MakeStruct_FieldInfluenceCapsule;           // 0x0160(0x0090)(NoDestructor)
	class UFieldManagerSubsystem*                 CallFunc_GetWorldSubsystem_ReturnValue_1;          // 0x01F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFieldInteractionImpulse               K2Node_MakeStruct_FieldInteractionImpulse;         // 0x0200(0x00B0)(NoDestructor)
	class AFieldInteractionManager*               CallFunc_GetManager_ReturnValue;                   // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_MakeStruct_StartTime_ImplicitCast;          // 0x02BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_DamageActorLacrimosaUltraSkill_C_ExecuteUbergraph_DamageActorLacrimosaUltraSkill;
