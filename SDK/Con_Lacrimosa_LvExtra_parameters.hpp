...
struct Con_Lacrimosa_LvExtra_C_CanApplyGameplayEffectContent final
{
public:
	...
	class FName                                   CallFunc_GetMainCharacterID_ReturnValue;           // 0x0034(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Con_Lacrimosa_LvExtra_C_CanApplyGameplayEffectContent;
