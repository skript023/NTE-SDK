...
public:
	...
	TMap<class FString, class UEnhancedPlayerMappableKeyProfile*> SavedKeyProfilesMap;               // 0x00D8(0x0050)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	TSet<class UInputMappingContext*>             RegisteredMappingContexts;                         // 0x0130(0x0050)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	class UEnhancedInputUserSettings*             UserSettings;                                      // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TSet<class UInputAction*>                     LastInjectedActions;                               // 0x07E8(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	void ChangeKey(const class UInputAction* Action, const struct FKey& PreviousKey, const struct FKey& NewKey);
