...
public:
	...
	static struct FGeometryScriptRenderCaptureTextures BakeTextureFromRenderCapturesStaticMesh(class UStaticMesh* TargetMesh, const struct FTransform& TargetLocalToWorld, const struct FGeometryScriptBakeTargetMeshOptions& TargetOptions, const TArray<class AActor*>& SourceActors, const struct FGeometryScriptBakeRenderCaptureOptions& BakeOptions, class UGeometryScriptDebug* Debug);
	static struct FGeometryScriptRenderCaptureTextures BakeTextureFromRenderCapturesStaticMeshComponents(class UStaticMesh* TargetMesh, const struct FTransform& TargetLocalToWorld, const struct FGeometryScriptBakeTargetMeshOptions& TargetOptions, const TArray<class UActorComponent*>& SourceComponents, const struct FGeometryScriptBakeRenderCaptureOptions& BakeOptions, class UGeometryScriptDebug* Debug);
