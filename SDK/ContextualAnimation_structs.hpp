...
public:
	...
	TArray<class UContextualAnimSelectionCriterion*> SelectionCriteria;                              // 0x0068(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
