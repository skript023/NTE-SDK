...
// Function EnhancedInput.InputMappingContext.ChangeKey
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// const class UInputAction*               Action                                                 (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FKey&                      PreviousKey                                            (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FKey&                      NewKey                                                 (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UInputMappingContext::ChangeKey(const class UInputAction* Action, const struct FKey& PreviousKey, const struct FKey& NewKey)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InputMappingContext", "ChangeKey");

	Params::InputMappingContext_ChangeKey Parms{};
