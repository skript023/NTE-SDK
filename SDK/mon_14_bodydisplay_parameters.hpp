...
struct mon_14_bodydisplay_C_Received_Notify final
{
public:
	...
	class Amon_14_BP_C*                           K2Node_DynamicCast_AsMon_14_BP;                    // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_mon_14_bodydisplay_C_Received_Notify;
