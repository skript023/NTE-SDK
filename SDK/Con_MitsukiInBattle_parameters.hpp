...
struct Con_MitsukiInBattle_C_CanApplyGameplayEffectContent final
{
public:
	...
	bool                                          CallFunc_GetPlayerFightState_ReturnValue;          // 0x0032(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_MitsukiInBattle_C_CanApplyGameplayEffectContent;
