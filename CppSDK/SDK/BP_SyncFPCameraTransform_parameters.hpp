...
// Function BP_SyncFPCameraTransform.BP_SyncFPCameraTransform_C.Received_NotifyEnd
// 0x0070 (0x0070 - 0x0000)
struct BP_SyncFPCameraTransform_C_Received_NotifyEnd final
{
public:
	...
	class UHTFirstPersonCameraManager*            CallFunc_GetFirstPersonCameraManager_ReturnValue;  // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetFPCameraSyncParentTransformState_InTime_ImplicitCast; // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_SyncFPCameraTransform_C_Received_NotifyEnd;
