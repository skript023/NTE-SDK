...
public:
	...
	uint8                                         Pad_30[0x2390];                                    // 0x0030(0x2390)(Fixing Size After Last Property [ Dumper-7 ])
	class UMassReplicatorBase*                    CachedReplicator;                                  // 0x23C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
