...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x0C70)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPostProcessSettings                   OutPPSettings;                                     // 0x0010(0x0AC0)(Parm, OutParm, NativeAccessSpecifierPublic)
	float                                         OutPPBlendWeight;                                  // 0x0AD0(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0AD4(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_AD5[0xB];                                      // 0x0AD5(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
