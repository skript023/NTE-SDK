...
struct BP_Notify_SetHeldItemVisual_C_Received_Notify final
{
public:
	...
	class AHTCrowdCharacterActorBase*             K2Node_DynamicCast_AsHTCrowd_Character_Actor_Base; // 0x0050(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_Notify_SetHeldItemVisual_C_Received_Notify;
