...
struct BTTask_SetBackLocation_C_ExecuteUbergraph_BTTask_SetBackLocation final
{
public:
...
DUMPER7_ASSERTS_BTTask_SetBackLocation_C_ExecuteUbergraph_BTTask_SetBackLocation;

// Function BTTask_SetBackLocation.BTTask_SetBackLocation_C.ReceiveExecuteAI
// 0x0010 (0x0010 - 0x0000)
struct BTTask_SetBackLocation_C_ReceiveExecuteAI final
{
public:
	class AAIController*                          OwnerController;                                   // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APawn*                                  ControlledPawn;                                    // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BTTask_SetBackLocation_C_ReceiveExecuteAI;
