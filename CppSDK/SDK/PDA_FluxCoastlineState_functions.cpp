...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::SetTextures(class UTexture* WorldCoastline, class UTexture* WorldGround)
{
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::SetDomain(const struct FVector& Location, const struct FVector& Size, const struct FIntPoint& Resolution, double PixelSize, double CaptureOffset_0, double Width)
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::GetWorldTransform(struct FTransform* NewParam)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PDA_FluxCoastlineState_C", "GetWorldTransform");

	Params::PDA_FluxCoastlineState_C_GetWorldTransform Parms{};
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::GetExternalReferences(TArray<class UTexture*>* Objects)
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::ExecuteUbergraph_PDA_FluxCoastlineState(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::CopyPropertiesToObject(class UObject* Destination, bool* Done)
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::ClearExternalReferences()
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::ApplyNiagaraData(class UNiagaraComponent* NiagaraSystem, bool UseGround)
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::GetWorldToTextureUV(struct FLinearColor* WorldToTextureUV) const
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::GetTextureSize(struct FIntPoint* Resolution) const
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::GetSurfaceHeight(double* SurfaceHeight) const
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::GetPixelSize(struct FLinearColor* WorldToSimulationUV) const
{
	static class UFunction* Func = nullptr;
...
void PDA_FluxCoastlineState::UPDA_FluxCoastlineState_C::ApplyMaterialData(TArray<class UMaterialInstanceDynamic*>& MaterialInstances) const
{
	static class UFunction* Func = nullptr;
