...
// Function Con_Skia_ShadowBase_GuangXiang.Con_Skia_ShadowBase_GuangXiang_C.CanApplyGameplayEffectContent
// 0x0060 (0x0060 - 0x0000)
struct Con_Skia_ShadowBase_GuangXiang_C_CanApplyGameplayEffectContent final
{
public:
	...
	class AHTCharacter*                           K2Node_DynamicCast_AsHTCharacter_1;                // 0x0038(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_K2_HaveGameplayEffectWithClass_ReturnValue_1; // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x005A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Skia_ShadowBase_GuangXiang_C_CanApplyGameplayEffectContent;
