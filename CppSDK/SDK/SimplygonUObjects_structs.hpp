...
// Enum SimplygonUObjects.ESimplygonHLODMeshType
// NumValues: 0x0007
enum class ESimplygonHLODMeshType : uint8
{
	None                                     = 0,
	DirectAggregationPart                    = 1,
	AttachmentPart                           = 2,
	RemeshUseLowestLOD                       = 3,
	ExcludeFromHLOD                          = 4,
	DirectAggregationPartPCAndMobile         = 5,
	ESimplygonHLODMeshType_MAX               = 6,
};
...
public:
	...
	struct FGenerateLightmapTexCoordSettings      GenerateLightmapTexCoordSettings;                  // 0x01A0(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
