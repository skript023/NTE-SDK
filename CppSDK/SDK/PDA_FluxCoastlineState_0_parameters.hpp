...
public:
	...
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class PDA_FluxCoastlineState_0::UPDA_FluxCoastlineState_C* TargetObject;                         // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	class PDA_FluxCoastlineState_0::UPDA_FluxCoastlineState_C* K2Node_DynamicCast_AsPDA_Flux_Coastline_State; // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_PDA_FluxCoastlineState_C_GetVolumeTransform;
