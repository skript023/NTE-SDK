...
struct BP_AnimNotify_ShowBubbleMsg_C_Received_Notify final
{
public:
	...
	class AHTCrowdCharacterActorBase*             K2Node_DynamicCast_AsHTCrowd_Character_Actor_Base; // 0x0068(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_AnimNotify_ShowBubbleMsg_C_Received_Notify;
