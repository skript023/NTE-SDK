...
{
public:
	struct FVector                                TestVector;                                        // 0x02C8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<float>                                 MultipleFloats;                                    // 0x02E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, NativeAccessSpecifierPublic)
	struct FTestMovieSceneStruct                  SingleStruct;                                      // 0x02F0(0x0020)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FTestMovieSceneStruct>          MultipleStructs;                                   // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, NativeAccessSpecifierPublic)
