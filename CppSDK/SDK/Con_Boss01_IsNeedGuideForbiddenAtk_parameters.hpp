...
struct Con_Boss01_IsNeedGuideForbiddenAtk_C_CanApplyGameplayEffectContent final
{
public:
	...
	bool                                          CallFunc_HasGuideFinish_ReturnValue;               // 0x0022(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_HasGuideFinish_ReturnValue_1;             // 0x0023(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Boss01_IsNeedGuideForbiddenAtk_C_CanApplyGameplayEffectContent;
