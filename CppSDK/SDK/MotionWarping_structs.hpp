...
public:
	...
	TArray<class UMotionWarpingSwitchOffCondition*> SwitchOffConditions;                             // 0x0008(0x0010)(BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
