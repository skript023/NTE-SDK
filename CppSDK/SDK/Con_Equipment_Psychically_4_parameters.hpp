...
struct Con_Equipment_Psychically_4_C_CanApplyGameplayEffectContent final
{
public:
	...
	bool                                          CallFunc_IsUsingMelee_ReturnValue;                 // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Con_Equipment_Psychically_4_C_CanApplyGameplayEffectContent;
