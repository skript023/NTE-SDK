...
enum class ENiagaraReorientedRibbonsDirectLightingMode : uint8
{
	Off                                      = 0,
	Inline                                   = 1,
	ENiagaraReorientedRibbonsDirectLightingMode_MAX = 2,
};
...
enum class ENiagaraReorientedSpritesDirectLightingMode : uint8
{
	Off                                      = 0,
	Inline                                   = 1,
	ENiagaraReorientedSpritesDirectLightingMode_MAX = 2,
};
...
{
public:
	class UNiagaraDataChannelReader*              Reader;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TMap<class FName, class UNiagaraDataInterface*> NamedDataInterfaces;                             // 0x0090(0x0050)(UObjectWrapper, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class UNiagaraComponent*>              SpawnedComponents;                                 // 0x0040(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
