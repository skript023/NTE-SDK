...
public:
	...
	class UInterchangeFbxTranslatorSettings*      CacheFbxTranslatorSettings;                        // 0x0068(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
