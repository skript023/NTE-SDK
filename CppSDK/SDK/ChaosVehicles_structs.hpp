...
public:
	...
	TArray<float>                                 GearChangeUpSpeedLimit;                            // 0x0018(0x0010)(Edit, ZeroConstructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	TArray<float>                                 ReverseGearRatios;                                 // 0x0028(0x0010)(Edit, ZeroConstructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	float                                         ChangeUpRPM;                                       // 0x0038(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ChangeDownRPM;                                     // 0x003C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GearChangeTime;                                    // 0x0040(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TransmissionEfficiency;                            // 0x0044(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct alignas(0x10) FVehicleAnimationInstanceProxy : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_7E0[0x18];                                     // 0x07E0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
#pragma pack(pop)
