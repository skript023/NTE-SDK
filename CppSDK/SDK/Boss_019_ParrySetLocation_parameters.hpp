...
struct Boss_019_ParrySetLocation_C_Received_Notify final
{
public:
	...
	class Aboss_19_BP_C*                          K2Node_DynamicCast_AsBoss_19_BP;                   // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Boss_019_ParrySetLocation_C_Received_Notify;
